...
public class Toolbar_ActionMode_Callback implements ActionMode.Callback {
    ...
    private ItemsView.RecyclerViewAdapter recyclerView_adapter;
   private ArrayList<Item> message_models;
    private boolean isListViewFragment;


    public Toolbar_ActionMode_Callback(Context context, ItemsView.RecyclerViewAdapter recyclerView_adapter, ArrayList<Item> message_models, boolean isListViewFragment) {
            ...
            case R.id.action_copy:
                ...
                for (int i = (selectedMessageSize - 1); i >= 0; i--) {
                    if (selected.valueAt(i)) {
                        ...
                        Item model = message_models.get(selected.keyAt(i));
